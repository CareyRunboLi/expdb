...
\begin{theorem}[OpenAI \cite{OpenAI_186}]
One has
\[
...
\begin{table}[ht]
    ...
    \hline
    Stadlmann (2026) \cite{Stadlmann_240} & $H_1 \le 240$ & \\
    \hline
    Charton--Hong--Lau--Ono--Remy--Siu--Swaminathan--Thorner--Xie (2026) \cite{AxiomMath_212} & $H_1 \le 212$ & \\
    \hline
    OpenAI (2026) \cite{OpenAI_186} & $H_1 \le 186$ & \\
    \hline
    \end{tabular}
    \end{table}

The current best known lower bound on $G(X)$ is
\begin{theorem}[OpenAI (2026) \cite{OpenAI_LargeGap}]
...
\begin{table}[ht]
    ...
    \hline
    GPT 5.6 Sol (2026) \cite{GPT56Sol_LargeGap} & $\displaystyle G(X) \gg \frac{\log X \log \log X}{\log \log \log \log X}$ \\
    \hline
    OpenAI (2026) \cite{OpenAI_LargeGap} & $\displaystyle G(X) \gg \frac{\log X (\log \log X)^2 \log\log\log \log X}{(\log \log \log X)^2}$ \\
    \hline
    \end{tabular}
    \end{table}
